...
<div class="info-container container-fluid bg-primary text-white py-2">
    <div class="container d-flex justify-content-between align-items-center">
        <p class="mb-0">Contact Number: 061-578268, 573511</p>
        <div>
  ...
  <!-- Information Container End -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <a href="index.html" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"></i><img src="img/Logo.png" alt="Gurukul logo" height="70px"></h2>
        </a>
